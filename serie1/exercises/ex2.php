...
3) Creer des instances (objets) de votre classe Animal. Faites appel a la methode que vous venez de creer et en fonction de si l'animal est adoptable ou non, vous devez voir le message correspondant s'afficher
