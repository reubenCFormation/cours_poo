...
5) Dans votre classe Animal, creer une methode qui va pouvoir recuperer tous nos animaux. Retourner un seul tableau qui contiendront vos instances (soit Mammal, soit Reptile) en fonction du type d'animal. Votre methode doit etre statique. Testez l'appel a la methode depuis votre classe Animal (en mode statique) Hint: pensez a rajouter qq chose aux constructeurs de vos enfants! (Mammal,Reptile)
